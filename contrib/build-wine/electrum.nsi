...
;Variables
  ...
  !define PRODUCT_WEB_SITE "https://github.com/wagerr/Wagerr-Electrum"
...
Section
  ...
  ;Links wagerr: URI's to Electrum
  WriteRegStr HKCU "Software\Classes\wagerr" "" "URL:wagerr Protocol"
  WriteRegStr HKCU "Software\Classes\wagerr" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\wagerr" "DefaultIcon" "$\"$INSTDIR\electrum.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\wagerr\shell\open\command" "" "$\"$INSTDIR\electrum-${PRODUCT_VERSION}.exe$\" $\"%1$\""
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\wagerr"
